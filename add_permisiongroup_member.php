...
<div class="row">
	...
	<div class="col-sm-6">
		<div class="panel panel-primary">
			<div class="panel-heading"><strong><?php echo _("Add Permision Group Member(s)"); ?>:</strong> <?php echo get_group_name($gid);?></div>
			<div class="panel-body">
				<form action="do_add_permisiongroup_member.php" method="POST">
